...
export class Notification extends Component {
    ...
    componentDidMount() {
        axios.get(`https://easybiciback.herokuapp.com/Cicla/` + this.props.res.bici)
            .then(res => {
                    ...
                    <Container style={texto1}>
                        <Container style={texto2}>
                            <Typography gutterBottom>
                                {this.state.bici.marca} / {this.state.bici.tipo}
                            </Typography>
                            <div style={scorer}>
                                <StarIcon style={color} />
                                <Typography gutterBottom>
                                    {this.state.bici.puntuacion}
                                </Typography>
                            </div>
                        </Container>
                        <Typography variant="h5" align="left">
                            <b> {this.props.res.estado}</b> 
                        </Typography>
